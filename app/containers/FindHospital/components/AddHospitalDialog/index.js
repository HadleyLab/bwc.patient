...
import {FindHospitalContainer} from "../../index";
                ...
                <div  className={classes.modalCover}>
                    ...
                    <div className={classes.contentCover}>
                        ...
                        <div className={classes.formCover}>
                           ...
                           <FullColumn>
                               <TextField name="name" label={trans('dialog.manually.add.hospital.name')} fullWidth  classes={{bootstrapInput: classes.cssInput}} />
                           </FullColumn>
                           <FullColumn>
                               <TextField  name="address" label={trans('dialog.manually.add.hospital.address')} fullWidth  classes={{bootstrapInput: classes.cssInput}} />
                           </FullColumn>
                           <FullColumn>
                                   ...
                                   <HalfColumn className={classes.mobileColumn}>
                                       <FlexBetween  className={classes.mobileFlexSmall}>
                                           <HalfColumn  className={classes.mobileSmallColumn}>
                                               <TextField  name="city" label={trans('dialog.add.hospital.select.city')} fullWidth  classes={{bootstrapInput: classes.cssInput}} />
                                           </HalfColumn>
                                           <HalfColumn className={classes.mobileSmallColumn}>
                                               <TextField  name="zip" label={trans('dialog.manually.add.hospital.zip')} fullWidth  classes={{bootstrapInput: classes.cssInput}} />
                                           </HalfColumn>
                                       </FlexBetween>
                                   </HalfColumn>
                               </FlexBetween>
                           ...
                           <FullColumn>
                               <FlexBetween  className={classes.mobileFlexSmall}>
                                   <HalfColumn className={classes.mobileSmallColumn}>
                                       <TextField  name="phone" label={trans('dialog.manually.add.hospital.phone')} fullWidth classes={{bootstrapInput: classes.cssInput}}  />
                                   </HalfColumn>
                                   <HalfColumn className={classes.mobileSmallColumn}>
                                   <TextField  name="phone2" label={trans('dialog.manually.add.hospital.phone2')} fullWidth  classes={{bootstrapInput: classes.cssInput}} />
                               </HalfColumn>
                               </FlexBetween>
                           </FullColumn>
                            <FullColumn>
                                <Typography className={classes.subTitle}>{trans('dialog.manually.add.hospital.subtitle.pfield')}</Typography>
                            </FullColumn>
                            <FullColumn>
                                <FlexBetween  className={classes.mobileFlexSmall}>
                                    <HalfColumn className={classes.mobileSmallColumn}>
                                        <TextField  name="MRN" label={trans('dialog.manually.add.hospital.mrn')} fullWidth classes={{bootstrapInput: classes.cssInput}}  />
                                    </HalfColumn>
                                </FlexBetween>
                            </FullColumn>
                       </div>

                        <RoundedButton  variant='raised' type={"submit"} color='primary'>
